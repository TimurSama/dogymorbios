  ...
  if (variant === 'ball') {
    return (
      <div className={cn('flex justify-center items-center', className)} style={{ width: size, height: size }}>
        <motion.div
          className="rounded-full bg-[var(--honey)]"
    ...
    return (
      <div className={cn('relative', className)} style={{ width: size, height: size }}>
        {[0, 1, 2, 3, 4, 5].map((i) => (
          ...
          >
            <svg viewBox="0 0 24 24" fill="currentColor" className="text-[var(--sky)]">
  ...
  if (variant === 'medallion') {
    return (
      <div className={cn('flex flex-col items-center', className)}>
        ...
        >
          <div className="absolute w-full h-full bg-[var(--sky)] rounded-full" />
        </motion.div>
        <motion.div
